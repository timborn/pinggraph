...
base_dir="/Users/timborn/pinggraph"
graph_dir="/Users/timborn/pinggraph/graphs"
log="$base_dir/log/zping.log"

[ $DEBUG ] && echo base_dir=$base_dir
[ $DEBUG ] && echo graph_dir=$graph_dir
[ $DEBUG ] && echo log=$log
...
[ $DEBUG ] && echo worker process is running
